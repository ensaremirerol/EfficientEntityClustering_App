              ...
              : SelectionArea(
                  child: DataTable(
                      ...
                      columns: [
                            ...
                            onSort: (columnIndex, ascending) {
                              if (ascending) {
                                ref.read(entityProvider.notifier).sortBy(
                                    ...
                                    columnIndex,
                                    (e1, e2) =>
                                        e2.entity_id.compareTo(e1.entity_id));
                              } else {
                                ref.read(entityProvider.notifier).sortBy(
                                    ascending,
                                    columnIndex,
                                    (e1, e2) =>
                                        e1.entity_id.compareTo(e2.entity_id));
                              }
                            }),
                        DataColumn(
                            ...
                            onSort: (columnIndex, ascending) {
                              if (ascending) {
                                ref.read(entityProvider.notifier).sortBy(
                                    ...
                                    columnIndex,
                                    (e1, e2) =>
                                        e2.mention.compareTo(e1.mention));
                              } else {
                                ref.read(entityProvider.notifier).sortBy(
                                    ascending,
                                    columnIndex,
                                    (e1, e2) =>
                                        e1.mention.compareTo(e2.mention));
                              }
                            }),
                        DataColumn(
                        ...
                        DataColumn(
                            label:
                                const Text('entity_has_mention_vector').tr()),
